...
const Navbar = () => {
  ...
  const links = <>
    ...
    <li>
      <NavLink to={'/availableFoods'}  className={({isActive}) => isActive? 'text-primary font-semibold' : 'font-semibold'}>Available Foods</NavLink>
    </li>

    <li>
      {
        user?.email &&
        <NavLink to={'/addFood'}  className={({isActive}) => isActive? 'text-primary font-semibold' : 'font-semibold'}>Add Food</NavLink>
      }
    </li>
    ...
    <li>
      {
        user?.email &&
        <NavLink to={'/manageMyFoods'}  className={({isActive}) => isActive? 'text-primary font-semibold' : 'font-semibold'}>Manage My Foods</NavLink>
      }
    </li>
    ...
    <li>
      {
        user?.email &&
        <NavLink to={'/myFoodRequest'}  className={({isActive}) => isActive? 'text-primary font-semibold' : 'font-semibold'}>My Food Request</NavLink>
      }
    </li>
  ...
  return (
    <div>
      <div className="navbar rounded-lg mb-2  z-10">
        <div className="navbar-start">
          ...
          <NavLink to={'/'} className=" text-gray-600 font-bold text-3xl border-2">
        ...
        <div className="navbar-end  gap-3 "> 
          ...
          <div className="tooltip h-8 w-8  tooltip-bottom" data-tcenterip="Theme">
          ...
          <div className='space-x-5'>
            {
              user ?
              <div>
                <div title={user?.displayName} className="dropdown dropdown-end z-10">
              ...
              <div>
                <NavLink to={'/login'}>
                <button className=' btn btn-primary hidden md:flex lg:flex'>Log In</button>
                </NavLink>
                <NavLink to={'/login'}>
                <button className='
                 md:hidden  lg:hidden text-3xl'><FaRegCircleUser></FaRegCircleUser></button>
                </NavLink>
              </div>
            }
          </div>
