      ...
      <div className="carousel w-full max-h-[500px]">
        <div name="slide1" className="carousel-item relative w-full ">
          ...
          <div className='text-white space-y-4'>
            <h1 className='text-6xl font-bold text-yellow-400'>FREE FREE FREE! <br /><span className='text-gray-100'>Order Food Anytime</span> <br /><span className='text-blue-600'>& Anywhere</span></h1>
            <p className='capitalize text-2xl'>There are many variations of food available <br />Take your favorite food now!!</p>
            <div>
